          ...
          {walletData ? (
            <div className="flex flex-col">
              {savedUsername ? (
                ...
                <span className="font-medium text-gray-900">{wallet?.adapter?.name || "Wallet 1"}</span>
              )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Choose a username for your wallet. This will be your identity for
            ...
            <div className="mb-6 p-3 bg-gray-50 rounded-md">
              <h3 className="text-sm font-medium text-gray-700 mb-2">
                Benefits of setting a username:
              </h3>
              <ul className="space-y-2 text-xs text-gray-600">
                <li className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                  <span>
                    Friends can send you SOL using @{username || "username"}{" "}
                ...
                <li className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                  <span>
                    Your username is saved as a compressed NFT using Light
                    Protocol
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                  <span>
                    Usernames make transactions social and easy to remember
                  </span>
                </li>
              </ul>
            </div>
              ...
              <div className="mb-4 p-3 bg-gray-50 rounded-md">
                ...
                <div className="w-full bg-gray-200 rounded-full h-1.5">
                  <div
                    ...
                    style={{
                      width:
                        registrationStep === "creating-account" ? "40%" : "80%",
                    }}
                  ></div>
                </div>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-7 px-3 py-2 border ${
                    isUsernameValid ? "border-green-300" : "border-gray-300"
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-black text-gray-900`}
              ...
              {recipientUsername && !isCheckingUsername && !isUsernameValid && (
                <p className="mt-1 text-xs text-red-500">Username not found</p>
              )}
            </div>
